...
// into Firestore from JSON assets, using the SAME document ID (metricId)
// in both collections.
//
// Run with:
...
Future<void> _seedMetricDataCollection(
  ...
  for (final point in items) {
    // ✅ Use the metricId as the document ID in metricData
    final docId = point.metricId;
    ...
    print('[metricData] Seeded metric point: $docId');
  }
}
